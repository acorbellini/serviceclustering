...
class KMedoids(BaseEstimator, ClusterMixin, TransformerMixin):
    ...
    def fit(self, D, y=None):
        ...
        self.cluster_centers_ = D.take(medoid_ics, axis=0)

        # Expose labels_ which are the assignments of
        # the training data to clusters
        self.labels_ = np.argmax(self.cluster_centers_, axis=0)
    ...
    def _get_cluster_ics(self, D, medoid_ics):
        ...
        cluster_ics = np.argmax(D[medoid_ics, :], axis=0)
    ...
    def _update_medoid_ics_in_place(self, D, cluster_ics, medoid_ics):
        ...
        for cluster_idx in range(self.n_clusters):
            ...
            max_cost_idx = np.argmax(all_costs)

            # find the value of the minimum cost in cluster_idx
            max_cost = all_costs[max_cost_idx]
            ...
            if max_cost > curr_cost:
                ...
                medoid_ics[cluster_idx] = \
                    np.where(cluster_ics == cluster_idx)[0][max_cost_idx]
